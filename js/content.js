...
function get_products() {
    chrome.storage.sync.get({
      ...
      var settings = {
        ...
        // console.log(response);
            ...
            $.each(response, function (index, value) {
                ...
                $.each(value, function(k, v){
                    ...
                    $(".modal-body").addClass("container").append('<div class="col-sm-4 col-md-2"><label>'+ k + '</label><input type="text" value="' + v +'"/></div>');
        ...
        jQuery('body').prepend('<div id="pop-up-container"><div tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button id="save_changes_header" class="btn btn-secondary">save changes </button><h5 class="Product Name" id="exampleModalLongTitle">Product Name</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"><ul class="nav nav-tabs"><li role="presentation" class="active"><a href="#">Details</a></li><li role="presentation"><a href="#">Images and videos </a></li><li role="presentation"><a href="#">Inventory</a></li><li role="presentation"><a href="#">Other details</a></li></ul></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button><button type="button" class="btn btn-primary">Save changes</button></div></div></div></div></div>');
